...
async function verifyModule5() {
  ...
  console.log(`\n======================================================`);
  console.log(`BẮT ĐẦU CHẤM THỬ TOÀN BỘ MODULE 5 TRÊN SANDBOX THỰC TẾ...`);
  console.log(`======================================================`);
  ...
  console.log(`\n======================================================`);
  console.log(`KẾT QUẢ TỔNG KẾT MODULE 5:`);

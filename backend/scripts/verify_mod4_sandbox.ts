...
async function verifyModule4() {
  const service = new ExerciseService();

  const lessons = await prisma.lesson.findMany({
    where: {
      lessonId: { startsWith: 'LS-04' }
    },
    include: {
      codingExercises: {
  ...
  console.log(`\n======================================================`);
  console.log(`BẮT ĐẦU CHẤM THỬ TOÀN BỘ MODULE 4 TRÊN SANDBOX THỰC TẾ...`);
  console.log(`======================================================`);
  ...
  console.log(`\n======================================================`);
  console.log(`KẾT QUẢ TỔNG KẾT MODULE 4:`);
